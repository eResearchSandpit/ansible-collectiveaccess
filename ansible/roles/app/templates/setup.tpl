...
if (!defined("__CA_APP_DISPLAY_NAME__")) {
	define("__CA_APP_DISPLAY_NAME__", "Playground");
}
...
#
#if (!defined("__CA_PAYPAL_API_USERNAME__")) {
#	define("__CA_PAYPAL_API_USERNAME__", "your_paypal_api_username");
#}
#if (!defined("__CA_PAYPAL_API_PASSWORD__")) {
#	define("__CA_PAYPAL_API_PASSWORD__", "your_paypal_api_password");
#}
#if (!defined("__CA_PAYPAL_API_SIGNATURE__")) {
#	define("__CA_PAYPAL_API_SIGNATURE__", "your_paypal_api_signature");
#}
#if (!defined("__CA_PAYPAL_API_ENVIRONMENT__")) {
#	define("__CA_PAYPAL_API_ENVIRONMENT__", "sandbox");
#}		// "sandbox" for testing or "live" for production use
